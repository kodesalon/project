...
include::{snippets}/board/images/success/path-parameters.adoc[]
include::{snippets}/board/images/success/request-parts.adoc[]
include::{snippets}/board/images/success/http-request.adoc[]

==== *성공*

include::{snippets}/board/images/success/http-response.adoc[]

==== *실패*

- 유효하지 않은 이미지 파일
include::{snippets}/board/images/fail/invalid-file/response-fields.adoc[]
include::{snippets}/board/images/fail/invalid-file/http-response.adoc[]
...
include::{snippets}/board/images/fail/not-exist-image/response-fields.adoc[]
include::{snippets}/board/images/fail/not-exist-image/http-response.adoc[]
