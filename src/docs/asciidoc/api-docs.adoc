...
- 유효하지 않은 비밀번호
include::{snippets}/member/changePassword/fail/invalid-password/response-fields.adoc[]
include::{snippets}/member/changePassword/fail/invalid-password/http-response.adoc[]

- 유효하지 않은 변경 시간
include::{snippets}/member/changePassword/fail/null-last-modified-date-time/response-fields.adoc[]
include::{snippets}/member/changePassword/fail/null-last-modified-date-time/http-response.adoc[]
