...
public class BoardRepositoryImpl implements BoardRepositoryCustom {
    ...
    public List<Board> selectBoards(final Long lastBoardId, final int size) {
        String query = "select distinct b from Board b join fetch b.writer left outer join b.images where b.id < :lastBoardId and b.deleted = false order by b.id desc";
